...
{
    public class ExcuseLoanCommandHandler : IRequestHandler<ExcuseLoanCommand, IActionResult>
    {
        ...
        public async Task<IActionResult> Handle(ExcuseLoanCommand request, CancellationToken cancellationToken)
        {
